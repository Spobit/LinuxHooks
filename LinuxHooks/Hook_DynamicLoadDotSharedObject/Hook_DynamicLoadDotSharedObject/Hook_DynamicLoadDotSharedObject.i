# 1 "Hook_DynamicLoadDotSharedObject.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "Hook_DynamicLoadDotSharedObject.cpp"
# 1 "Hook_DynamicLoadDotSharedObject.h" 1
...
# 510 "/usr/include/c++/5/bits/stl_algobase.h" 3
  template<bool, bool, typename>
...
# 538 "/usr/include/c++/5/bits/stl_algobase.h" 3
  template<>
...
# 568 "/usr/include/c++/5/bits/stl_algobase.h" 3
  template<bool _IsMove>
...
# 690 "/usr/include/c++/5/bits/stl_algobase.h" 3
...
# 5 "Hook_DynamicLoadDotSharedObject.h" 2
...
# 6 "Hook_DynamicLoadDotSharedObject.h" 2
...
# 11 "Hook_DynamicLoadDotSharedObject.h"
...
# 29 "Hook_DynamicLoadDotSharedObject.h" 3 4
throw () __attribute__ ((__nonnull__ 
# 29 "Hook_DynamicLoadDotSharedObject.h"
       (2)
# 29 "Hook_DynamicLoadDotSharedObject.h" 3 4
       ))
# 29 "Hook_DynamicLoadDotSharedObject.h"
                      ;
# 2 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
# 4 "Hook_DynamicLoadDotSharedObject.cpp" 2
# 1 "/usr/include/stdio.h" 1 3 4
...
# 5 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
# 6 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
typedef int error_t;
# 7 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
extern void *mesa_memcpy (void *__restrict __dest, const void *__restrict __src,
       size_t __n) throw () __attribute__ ((__nonnull__ (1, 2)));


extern void *mesa_memmove (void *__dest, const void *__src, size_t __n)
     throw () __attribute__ ((__nonnull__ (1, 2)));
...
extern void *mesa_memset (void *__s, int __c, size_t __n) throw () __attribute__ ((__nonnull__ (1)));
...
extern "C++" const char *basename (const char *__filename)
     throw () __asm ("basename") __attribute__ ((__nonnull__ (1)));
# 678 "/usr/include/string.h" 3 4
}
# 8 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
# 9 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
# 10 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
# 11 "Hook_DynamicLoadDotSharedObject.cpp" 2
...
# 13 "Hook_DynamicLoadDotSharedObject.cpp" 2
# 1 "DlopenPtrAddr.h" 1
...
# 14 "Hook_DynamicLoadDotSharedObject.cpp" 2
# 1 "Module.h" 1
...
# 5 "Module.h" 2
# 15 "Hook_DynamicLoadDotSharedObject.cpp" 2



# 17 "Hook_DynamicLoadDotSharedObject.cpp"
void* dlsym(void * __restrict handle, const char * __restrict symbol)
{
    do{}while (0);
    syslog(
# 20 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
          0x01
# 20 "Hook_DynamicLoadDotSharedObject.cpp"
                 , "%s", "Enter dlsym!");
    ...
    char tmpchars[
# 48 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
                 255
# 48 "Hook_DynamicLoadDotSharedObject.cpp"
                          ];
...
int get_load_libs_string_in_maps(std::map<std::string, int>& libs)
{
# 69 "Hook_DynamicLoadDotSharedObject.cpp"
    char tmpchars[
# 69 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
                 4096
# 69 "Hook_DynamicLoadDotSharedObject.cpp"
                         ] = "";
    ...
    FILE* fp = 
# 74 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
              __null
# 74 "Hook_DynamicLoadDotSharedObject.cpp"
                  ;
    int tmpint = 0;
    ...
    if (access(mapsfullpath.c_str(), 
# 83 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
                                    0 
# 83 "Hook_DynamicLoadDotSharedObject.cpp"
                                         | 
# 83 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
                                           4
# 83 "Hook_DynamicLoadDotSharedObject.cpp"
                                               ))
        do{ if (fp) { fclose(fp); fp = 
# 84 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
       __null
# 84 "Hook_DynamicLoadDotSharedObject.cpp"
       ; } snprintf(tmpchars, sizeof(tmpchars), "%s" " (%s:%u:%d)", strerror(
# 84 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
       (*__errno_location ())
# 84 "Hook_DynamicLoadDotSharedObject.cpp"
       ), "Hook_DynamicLoadDotSharedObject.cpp", 84, getpid()); libs.clear(); libs[tmpchars]++; return -1; }while (0);


    fp = fopen(mapsfullpath.c_str(), "r");
    if (!fp)
        do{ if (fp) { fclose(fp); fp = 
# 89 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
       __null
# 89 "Hook_DynamicLoadDotSharedObject.cpp"
       ; } snprintf(tmpchars, sizeof(tmpchars), "%s" " (%s:%u:%d)", strerror(
# 89 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
       (*__errno_location ())
# 89 "Hook_DynamicLoadDotSharedObject.cpp"
       ), "Hook_DynamicLoadDotSharedObject.cpp", 89, getpid()); libs.clear(); libs[tmpchars]++; return -1; }while (0);

    while (fgets(tmpchars, sizeof(tmpchars), fp))
        linestrings.push_back(tmpchars);
    tmpint = 
# 93 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
            (*__errno_location ())
# 93 "Hook_DynamicLoadDotSharedObject.cpp"
                 ;
    if (!feof(fp))
        do{ if (fp) { fclose(fp); fp = 
# 95 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
       __null
# 95 "Hook_DynamicLoadDotSharedObject.cpp"
       ; } snprintf(tmpchars, sizeof(tmpchars), "%s" " (%s:%u:%d)", strerror(tmpint), "Hook_DynamicLoadDotSharedObject.cpp", 95, getpid()); libs.clear(); libs[tmpchars]++; return -1; }while (0);

    fclose(fp);
    fp = 
# 98 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
        __null
# 98 "Hook_DynamicLoadDotSharedObject.cpp"
            ;


    char tmpchars1[6][
# 101 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
                     4096
# 101 "Hook_DynamicLoadDotSharedObject.cpp"
                             ] = {};
    ...
    if (0 == libs.size())
        do{ if (fp) { fclose(fp); fp = 
# 113 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
       __null
# 113 "Hook_DynamicLoadDotSharedObject.cpp"
       ; } snprintf(tmpchars, sizeof(tmpchars), "%s" " (%s:%u:%d)", "It is no libs loaded?", "Hook_DynamicLoadDotSharedObject.cpp", 113, getpid()); libs.clear(); libs[tmpchars]++; return -1; }while (0);
...
unsigned long long get_offset_from_dlopen_to_dlsym(const std::string& lib)
{
    ...
    FILE* fp = 
# 138 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
              __null
# 138 "Hook_DynamicLoadDotSharedObject.cpp"
                  ;
    char cmdchars[
# 139 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
                 4096
# 139 "Hook_DynamicLoadDotSharedObject.cpp"
                         ];
    ...
    for (size_t i = 0; i < sizeof(exportsmybols) / sizeof(char*); i++)
    {
        ...
        pclose(fp);
        fp = 
# 166 "Hook_DynamicLoadDotSharedObject.cpp" 3 4
            __null
# 166 "Hook_DynamicLoadDotSharedObject.cpp"
                ;
    }
